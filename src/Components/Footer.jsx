 ...
 <footer className='w-full bg-gray-900   pt-6 md:pt-[120px]  '>
     <div className='w-full px-4 grid  grid-cols-3 sm:grid-cols-1  '>
        <div className='h-[150px]'>
          ...
          <p className='text-white mt-[50px]'>your trusted partner for unforgettable travel experience.explore the world with us.</p>
        </div> 
      ...
      <div className='h-[200px]  text-center'>
        ...
        <button className='text-white font-semi-bold rounded-r-full   bg-blue-600'>Suscribe</button>
        </div>
