export const feature = [
  {
  image: 'https://github.com/YousafKhan1/Images/blob/main/Images/gal1.jpg?raw=true',
  name: 'Paris',
  des: 'thecity of lights draws million of visitors every year with its unforgettable ambiance'
 },
  {
    image: 'https://github.com/YousafKhan1/Images/blob/main/Images/gal2.jpg?raw=true',
    name: 'bali,indonesia',
    des: 'Bali is a living postcard, an indonesian paradise that feels like afantasy'
  },
  {
    image: 'https://github.com/YousafKhan1/Images/blob/main/Images/gal3.png?raw=true',
    name: 'New york,USA',
    des: 'Newyork city is the largest city in the united states and home to manyworld-famous attraction '
  },
  {
    image: 'https://github.com/YousafKhan1/Images/blob/main/Images/gal4.jpg?raw=true',
    name: 'Tokyo,Japan',
